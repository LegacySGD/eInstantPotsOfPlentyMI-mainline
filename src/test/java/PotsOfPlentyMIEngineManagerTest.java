...
public class PotsOfPlentyMIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PotsOfPlentyMIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PotsOfPlentyMIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PotsOfPlentyMIIW/InitOutcome.xml").getDocumentElement();
